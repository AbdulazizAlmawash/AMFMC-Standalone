...
AMFMC is a Windows standalone training application that presents an Airbus A320-style Flight Management Computer (FMC) interface and workflows for learning and practice.
...
Some antivirus tools may flag `AMFMC.exe` or bundled files. This can happen due to packaging/heuristics and does not necessarily indicate malware.
...
AMFMC is an unofficial training application and is not affiliated with or endorsed by Airbus. All trademarks are the property of their respective owners.
